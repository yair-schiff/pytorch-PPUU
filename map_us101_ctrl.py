from map_us101 import US101, US101Car
from traffic_gym_v2 import PatchedCar


class ControlledUS101Car(US101Car):
    ...
    def current_lane(self):
        ...
        if y <= bottom + 53 - x * 0.07:  # changed slope to 0.07 for US101 ramps
            return 5  # there are only 6 lanes in US101 map
...
class ControlledUS101(US101):

    # Environment's car class
    EnvCar = ControlledUS101Car
